...
<!--            <div class="email_captcha_login_icon">-->
<!--              <PhoneCaptchaIcon></PhoneCaptchaIcon>-->
<!--            </div>-->
<!--            <div class="email_captcha_input">-->
<!--              <el-input v-model="loginForm.captcha" placeholder="请输入手机验证码"></el-input>-->
<!--            </div>-->
<!--          </div>-->
...
import {PhoneIcon, PhoneCaptchaIcon} from "@/components/icons/index.js";
