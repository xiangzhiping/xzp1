...
<script setup>
import {ref} from 'vue';
import EmailCaptchaRegister from './register_account/email_captcha_register.vue';
import PhoneCaptchaRegister from './register_account/phone_captcha_register.vue';
import {EmailLoginIcon, PhoneLoginIcon} from "@/components/icons/index.js";

const currentTab = ref('emailTab');
const currentComponent = ref(EmailCaptchaRegister);
const animationDirection = ref('slide-fade-right');

const tabs = ref([
  {name: 'emailTab', component: EmailCaptchaRegister},
  {name: 'phoneTab', component: PhoneCaptchaRegister},
]);
